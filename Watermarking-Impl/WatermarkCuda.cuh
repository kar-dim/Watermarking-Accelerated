...
public:
	...
	WatermarkCuda(const WatermarkCuda&) = default;
	WatermarkCuda(WatermarkCuda&&) noexcept = default;
	WatermarkCuda& operator=(const WatermarkCuda&) = default;
	WatermarkCuda& operator=(WatermarkCuda&&) noexcept = default;
